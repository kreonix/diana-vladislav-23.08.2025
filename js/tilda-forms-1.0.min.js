...
var FORMS_API_FIELD = {
    ...
    var i = function t() {
        ...
        element: e, data: r, getValue: s, onChange: function t(e, r) {
            var o, n = (r || {}).uniqueKey;
            if (n) {
                var a;
                if (c.has(n)) return;
        ...
        }, _onChangeCallbacks: l, _uniqueOnChangeCallbacks: c
    }, _ = function t(e) {
    ...
    return e.data.inputs = Array.from(e.element.querySelectorAll('[type="checkbox"]')), e.focus = function () {
        ...
        var t = e.element.querySelector('[name="' + e.data.fieldName + '"]'), r = Number(e.data.defaultValue),
            o = null != r && r > 0;
        t_formsApi__safeSetValue(t, "", {silent: !0}), e.data.ownVariantInput && t_formsApi__sendReset(e.data.ownVariantInput), e.data.inputs.forEach((function (t) {
            return t.checked = !1
    ...
    try {
        ...
        return r.reset = function () {
            if (o) {
                var t = o.options[0], e = t && "" === t.value, n = Number(r.data.defaultValue) || 0,
                    a = Math.max(0, e ? n : n - 1), i;
    ...
    try {
        return Promise.resolve(_catch$1((function () {
            ...
            var t = e.closest(".t-rec"), r,
                o = Array.from(e.querySelectorAll(".t-input-group")).map(t_formsApi__initTildaField);
            return Promise.resolve(Promise.allSettled(o)).then((function (r) {
                ...
                })), t_formsApi__isConditionalForm(e) && t.dispatchEvent(new CustomEvent("sync-conditionals", {detail: {shouldPreventSubmit: !1}}))
            }))
        }), (function (t) {
...
var t_forms__updateAllVariables = function t(e) {
    try {
        var r = _catch((function () {
            var t = e.closest(".t-rec"), r = t_forms__getUsedVariables([t], {unique: !0}), o;
...
function t_forms__setupCloseHandlers(t, e) {
    var r = document.body, o = t.querySelector(".t-form-success-popup__close-icon"),
...
function t_forms__initForms() {
    ...
    var e = t_forms__getCanonicalUrl(), r = t_forms__isCachedPage();
    Array.prototype.forEach.call(t, (function (t) {
        ...
        if (!window.initForms[o]) {
            ...
            if (t_forms__initFormFields(t), t_forms__initEventPlaceholder(t), t_forms__addInputItsGood(t), t_forms__addAttrAction(t), t_forms__onSubmit(t), t_forms__onClick(t), t_forms__onRender(t), t_forms__addFocusOnTab(t), t_onFuncLoad("t_throttle", (function () {
...
function t_forms__removePlaceholder(t) {
    ...
    if ("INPUT" === r.tagName) {
        ...
        if (o) a = o.getAttribute("data-input-lid"); else {
...
function t_forms__addPlaceholder(t) {
    ...
    if (o) n = o.getAttribute("data-input-lid"); else {
    ...
    if (e || !document.body.classList.contains("t706__body_cartwinshowed") && !document.body.classList.contains("t706__body_cartpageshowed") || (r = document.querySelector(".t706")), r) {
        ...
        if (o) {
            ...
            if (o.classList.contains("t-form__inputsbox_inrow") || (n = r.querySelectorAll(".t-input-block_width")), 0 !== n.length) {
                ...
                var a = o.offsetWidth, i = ["rd", "ri", "uc", "ws", "hd", "fr", "st"];
...
function t_forms__initBtnClick(t) {
    ...
    if (o) {
        ...
        if (n) {
            ...
            if (o.tildaSendingStatus && (s = o.tildaSendingStatus), !(s && s >= 1 || t_hasClass(o, "t706__submit_disable"))) if (t_addClass(o, "t-btn_sending"), o.tildaSendingStatus = "1", window.tildaForm.hideErrors(n), i = window.tildaForm.validate(n), window.tildaForm.showErrors(n, i)) t_removeClass(o, "t-btn_sending"), o.tildaSendingStatus = "0"; else {
                var l, c = document.getElementById("allrecords").getAttribute("data-tilda-formskey"),
                    u = parseInt(n.getAttribute("data-formactiontype")), d;
                ...
                if (n.querySelector(".g-recaptcha") && window.grecaptcha) {
                    ...
                    if (p) window.grecaptcha.reset(p); else {
                        var w = {
                            size: "invisible",
...
window.t_forms__lang = (window.navigator.userLanguage || window.navigator.language).toUpperCase().slice(0, 2), window.scriptSysPayment = {}, window.handlerSysPayment = {}, window.isInitEventsZB = {}, window.isInitEventsCustomMask = {}, window.initForms = {}, window.tildaForm = {
    ...
    for (var e = t_forms__getElement(t), r = e.querySelectorAll(".js-tilda-rule"), o = [], n = !0, a = e.getAttribute("data-formcart"), i, s = t_forms__getConditionCheckHandler(e).isHiddenByCondition, l = 0; l < r.length; l++) {
        ...
        if (!s(c)) {
            var u = !!parseInt(c.getAttribute("data-tilda-req") || 0, 10),
                d = c.getAttribute("data-tilda-rule") || "none", m, f,
                _ = c.getAttribute("data-tilda-rule-minlength") || 0,
                p = c.getAttribute("data-tilda-rule-maxlength") || 0, w = {}, v = c.value, h = "",
                g = c.getAttribute("type"), y = c.getAttribute("name");
            w.obj = c, w.type = [], v && v.length && (h = v.replace(/[\s\u0000—\u001F\u2000-\u200F\uFEFF\u2028-\u202F\u205F-\u206F]/gi, ""), v = v.trim()), _ && (_ = parseInt(_, 10)), p && (p = parseInt(p, 10));
            var b = !v.length && !h.length, E = "checkbox" === g || "radio" === g,
                F = e.querySelectorAll('[name="' + y + '"]:checked').length,
                A = c.classList.contains("t-checkboxes__hiddeninput");
            if (A || "radio" === g) {
                var x = A ? "checkbox" : "radio", S = c.closest(".t-input-block"),
            ...
            if ((v.length && !E || E && F) && (n = !1), u && (b || E && !F)) w.type.push("req"); else {
                switch (d) {
                    case"email":
                        m = /^(?!\.)(?!.*\.\.)[a-zA-Zёа-яЁА-Я0-9\u2E80-\u2FD5\u3190-\u319f\u3400-\u4DBF\u4E00-\u9FCC\uF900-\uFAAD_\.\-\+]{0,63}[a-zA-Zёа-яЁА-Я0-9\u2E80-\u2FD5\u3190-\u319f\u3400-\u4DBF\u4E00-\u9FCC\uF900-\uFAAD_\-\+]@[a-zA-Zёа-яЁА-ЯЁёäöüÄÖÜßèéû0-9][a-zA-Zёа-яЁА-ЯЁёäöüÄÖÜßèéû0-9\.\-]{0,253}\.[a-zA-Zёа-яЁА-Я]{2,11}$/gi, v.length && !v.match(m) && w.type.push("email");
                        break;
                    case"url":
                        m = /^((https?|ftp):\/\/)?[a-zA-Zёа-яЁА-ЯЁёäöüÄÖÜßèéûşç0-9][a-zA-Zёа-яЁА-ЯЁёäöüÄÖÜßèéûşç0-9_\.\-]{0,253}\.[a-zA-Zёа-яЁА-Я]{2,10}\/?$/gi, v.length && ((f = (f = (f = v.split("//")) && f.length > 1 ? f[1] : f[0]).split("/")) && f.length && f[0] ? (f = f[0]).match(m) || w.type.push("url") : f && !f[0] || w.type.push("url"));
                        break;
                    case"phone":
                        var I = c.getAttribute("data-tilda-mask"), L = "^[0-9()+-";
                        I && (-1 !== I.indexOf("*") ? L += "a-zёа-я" : (-1 !== I.indexOf("a") && (L += "a-z"), -1 !== I.indexOf("а") && (L += "а-яё"))), L += "]+$", m = new RegExp(L, "gi"), (h.length && !h.match(m) || 1 == (f = h.replace(/[^0-9]+/g, "")).indexOf("000") || 1 == f.indexOf("111") && "9" != f.substring(0, 1) || 1 == f.indexOf("222") && "5" != f.substring(0, 1) || 1 == f.indexOf("333") || 1 == f.indexOf("444") || 1 == f.indexOf("5555") && "0" != f.substring(0, 1) || 1 == f.indexOf("666") && "0" != f.substring(0, 1) || 1 == f.indexOf("8888") && "4" != f.substring(0, 1)) && w.type.push("phone");
                        break;
                    case"number":
                    ...
                    case"date":
                        t_onFuncLoad("t_datepicker__readDateFromInput", (function () {
                            ...
                            h.length > 0 && !window.t_datepicker__isDateValid(t) && w.type.push("date")
                        }));
                        break;
                    case"time":
                    ...
                    case"chosevalue":
                        ...
                        break;
                    case"promocode":
                        "y" !== a || !h.length || !window.tcart || window.tcart.promocode && window.tcart.prodamount_discountsum || w.type.push("promocode");
                        break;
                    case"deliveryreq":
                ...
                _ > 0 && v.length && v.length < _ && w.type.push("minlength"), p > 0 && v.length && v.length > p && w.type.push("maxlength")
            }
            w.type && w.type.length && (o[o.length] = w)
        }
    }
    if ("y" === a) {
        var D = window.tcart_minorder > 0, M = window.tcart_mincntorder > 0, P;
        if (D) if ((P = window.tcart.prodamount_withdiscount > 0 ? window.tcart.prodamount_withdiscount : void 0 !== window.tcart.prodamount_withdyndiscount && window.t_cart__discounts && window.t_cart__discounts.length > 0 ? window.tcart.prodamount_withdyndiscount : window.tcart.prodamount) < window.tcart_minorder) {
            var q = {obj: {}, type: []};
    ...
    for (var _ = 0; _ < e.length; _++) if (e[_] && e[_].obj) {
        ...
        for (var w = 0; w < e[_].type.length; w++) {
            var v = e[_].type[w], h = t_forms__getMsg(v);
        ...
        if (Array.prototype.forEach.call(g, (function (t) {
            ...
            if (y && y.length) {
                var b, E = '.t1093 .t-popup[data-tooltip-hook="' + y[y.length - 1] + '"]',
                    F = document.querySelector(E), A = F ? getComputedStyle(F).zIndex : 0, x;
    ...
    var t = document.getElementById("tildaformsuccesspopup-new"), e = document.getElementById("tildaformsuccesspopup"),
    ...
    function m() {
        t_fadeIn(u), t_addClass(a, "t-body_success-popup-showed"), u.classList.add("t-popup_show"), f(u), t_forms__isIOS() && setTimeout((function () {
            window.tildaForm.lockBodyScroll()
        }), 500)
    }

    function f() {
        var t = 120, e = window.innerHeight - t, r = u.querySelector(".t-form-success-popup__wrapper"),
            o = getComputedStyle(r, null), n = parseInt(o.paddingTop) || 0, a = parseInt(o.paddingBottom) || 0, i, s, l;
    ...
    var n = o.closest(".t-popup"), a = o.closest(".t1093"), i;

    function s() {
        t_forms__handleSuccess(o, {
            successCallback: r,
            successUrl: e
        }), window.tildaForm.clearTCart(o), t_forms__clearFormInputs(o), t_forms__clearFormData(o), t_forms__isNewSuccessBox(o) && !a && window.t_forms__clearForm(o)
    }
    ...
    var btnSubmit = t_forms__getElement(btnSubmitNode)
    const formData = new FormData(formNode);

    // Получаем "Имя"
    const name = formData.get('Имя');

    // Получаем "Присутствие"
    const presence = formData.get('Присутствие');

    // Получаем "Напитки" — чекбоксы с одинаковым именем
    const drinks = formData.getAll('Напитки');

    const newFormData = new URLSearchParams();

    newFormData.append('entry.639282404', name);
    newFormData.append('entry.1075998017', presence);
    drinks.forEach(d => newFormData.append('entry.1435507491', d));


    fetch('https://docs.google.com/forms/u/0/d/e/1FAIpQLSckNXSQM0FUVT9w7p6qL7mgZyQDRqWNPmkubNk1TuhF_6FS8w/formResponse', {
        method: 'POST',
        body: newFormData,
        mode: 'no-cors' // важно для Google Form
    }).then(
        () => {
            window.tildaForm.successEnd(form)
        }
    ).catch(() => {
        console.log(123123)
...
function t_forms__onSuccess(t) {
    ...
    var e = t_forms__getElement(t), r = e.closest(".r"), o = r.getAttribute("data-record-type"),
        ...
        s = parseInt(a.paddingBottom) || 0, l, c,
        u = n.clientHeight - (i + s) + (n.getBoundingClientRect().top + window.pageYOffset),
        d = e.querySelector(".t-form__successbox"), m = d ? d.getBoundingClientRect().top + window.pageYOffset : 0, f,
        _ = window.innerHeight, p = document.body, w = document.documentElement,
    ...
    var g = "t" + o + "__inputsbox_hidden", y = [702, 708, 862, 945, 1014, 1114], b = !0;
    f = window.innerWidth > 960 ? m - 200 : m - 100;
    var E = document.querySelector(".t-tildalabel"), F = t_forms__isNewSuccessBox(e);
    if (m > window.scrollY || v - u < _ - 100) F || n.classList.add(g), _ > v && E && setTimeout((function () {
        t_fadeOut(E)
    }), 300); else {
        for (var A = 0; A < y.length; A++) if (y[A] == o) {
            b = !1;
            break
        }
    ...
    if (x && t_forms__handleRedirect(e, x, d), 835 == o || 862 == o) {
        var S = r.querySelector(".t" + o + "__btn_prev"), C = r.querySelector(".t" + o + "__wrapper"),
...
function t_forms__handleRedirect(t, e, r) {
    ...
    if (t_forms__isNewSuccessBox(t)) {
        var n = (null == r ? void 0 : r.getAttribute("data-success-title")) || "",
            a = (null == r ? void 0 : r.getAttribute("data-success-message")) || "", i = Boolean(n || a),
...
function t_forms__getSuccessBoxContent(t, e) {
    var r = t_forms__getMsg("success"), o = t.getAttribute("data-success-message"),
        n = {text: "", title: "", button: ""};
...
function t_forms__showSuccessPopup(t, e) {
    var r, o, n, a;
    if (!!t.closest(".t396")) window.tildaForm.showSuccessPopup(e.innerHTML); else {
        var i = {
...
function t_forms__handleSuccess(form, options) {
    ...
    if (callback && "function" == typeof window[callback]) "undefined" != typeof jQuery ? eval(callback + "(jQuery(form))") : eval(callback + "(form)"); else if (successUrl) {
...
function t_forms__getFormDataJSON(t) {
    var e = {}, r = t.querySelectorAll("input, textarea, button, select"), o,
        n = t_forms__getConditionCheckHandler(t).isHiddenByCondition, a = function t(r, o) {
            Array.isArray(e[r]) || (e[r] = []), e[r].push(o)
        };
    return r.forEach((function (t) {
        var r = t.name, o = t.type, i = t.disabled, s = t.value, l = t.checked, c = t.options;
        if (r && !i && !n(t) && !["file", "reset", "submit", "button"].includes(o) && (!["checkbox", "radio"].includes(o) || l)) if ("select-multiple" !== o) if (r.includes("[]")) {
            var u = r.replace("[]", "");
            a(u, s)
        } else e[r] = s; else Array.from(c || []).filter((function (t) {
            return t.selected
        })).forEach((function (t) {
            return a(r, t.value)
        }))
...
function t_forms__processFormsInPopup(t, e) {
    ...
    var n = e.closest(".t-rec"), a = n.getAttribute("data-record-type"), i;
    "121" === a && (a = t.querySelector(".t-popup__container").getAttribute("data-popup-type") || "121");
    var s = "t" + a + "_closePopup", l = n.id.replace("rec", ""), c = window[s];
...
function t_forms__isCachedPage() {
    try {
        for (var t = new URL(window.location.href), e = t.hostname, r = t.href, o, n = 0, a = [{
            ...
            domains: ["dzen.ru"],
            urlPattern: /\/away\?/
        }, {domains: ["yandexwebcache.net", "archive.today", "archive.ph", "archive.is", "web.archive.org", "ghostarchive.org", "cachedview.com"]}]; n < a.length; n++) {
            var i = a[n], s = i.domains.some((function (t) {
                return e === t
...
function t_forms__showWrongPageUrlMessage(t) {
    if (t) {
        var e = "tildaforms-origin-url-popup-notification", r = document.getElementById(e);
        if (r) i(r); else {
            ...
            var n = document.getElementById(e), a = n.querySelector(".t-form-success-popup__close-icon");
